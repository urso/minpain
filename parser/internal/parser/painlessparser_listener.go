...
type PainlessParserListener interface {
	...
	// EnterCapturingfuncref is called when entering the capturingfuncref production.
	EnterCapturingfuncref(c *CapturingfuncrefContext)
	...
	// ExitCapturingfuncref is called when exiting the capturingfuncref production.
	ExitCapturingfuncref(c *CapturingfuncrefContext)
