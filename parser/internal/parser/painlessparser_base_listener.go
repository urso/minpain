...
func (s *BasePainlessParserListener) EnterOperator(ctx *OperatorContext) {}

// ExitOperator is called when production operator is exited.
func (s *BasePainlessParserListener) ExitOperator(ctx *OperatorContext) {}
...
func (s *BasePainlessParserListener) EnterChain(ctx *ChainContext) {}

// ExitChain is called when production chain is exited.
func (s *BasePainlessParserListener) ExitChain(ctx *ChainContext) {}
...
// EnterCapturingfuncref is called when production capturingfuncref is entered.
func (s *BasePainlessParserListener) EnterCapturingfuncref(ctx *CapturingfuncrefContext) {}

// ExitCapturingfuncref is called when production capturingfuncref is exited.
func (s *BasePainlessParserListener) ExitCapturingfuncref(ctx *CapturingfuncrefContext) {}
